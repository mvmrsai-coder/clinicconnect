...
const navItems: NavItem[] = [
  ...
  { href: '/clinicconnect', labelKey: 'clinicconnect', icon: Stethoscope },
  { href: '/clinicconnect/patients', labelKey: 'clinicPatients', icon: Users },
  {
    href: '/clinicconnect/appointments',
    labelKey: 'clinicAppointments',
    icon: CalendarDays,
  },
  {
    href: '/clinicconnect/whatsapp',
    labelKey: 'clinicWhatsApp',
    icon: MessageCircle,
  },
