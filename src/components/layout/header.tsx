...
const pageTitles: Record<string, string> = {
  ...
  '/contacts': 'contacts',
  '/clinicconnect/profile': 'clinicProfile',
  '/clinicconnect/doctors': 'clinicDoctors',
  '/clinicconnect/services': 'clinicServices',
  '/clinicconnect/schedules': 'clinicSchedules',
  '/clinicconnect/patients': 'clinicPatients',
  '/clinicconnect/appointments': 'clinicAppointments',
  '/clinicconnect/whatsapp': 'clinicWhatsApp',
  '/clinicconnect': 'clinicconnect',
  '/pipelines': 'pipelines',
